...
<div class="TipForm2" id="TipForm2">
<img src="<?php echo base_url($cfg['tpl'])?>/images/kfbg.png" />
<img src="<?php echo base_url($cfg['tpl'])?>/images/close.gif" class="close" onClick="$('#TipForm2').hide()"/>
<span id="topqq" class="top11" style="width: 794px; margin-left: -10px;"><span id="topqq1">
...
<span id="topqq" class="top11" style="width: 794px;margin-left:-45px;"><span id="topqq1">
	...
	<header>
		...
		<?php }else{ ?>
			<a id="btreg" href="#" onClick="$('#ttipForm23').show()" >注册会员</a><a id="btlogin" onClick="showLoginForm();">登录</a> 
		<?php } ?>
		</span>
...
<div id="main" class="clearfix ption_r" style="">
	...
	<div class="notice">
	<marquee direction="left" id="notice" scrollamount="3">★金融在线的新老客户，本直播室现有原油、白银和黄金等多种交易产品，详情请点击上方QQ交谈进行咨询↑↑↑★</marquee>
	</div>
	<!-- 聊天开始 -->
